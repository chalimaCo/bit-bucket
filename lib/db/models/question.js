const
    ...
    questionSchema = mongoose.Schema({
        ...
        content: {type: String, required: [true, "content not provided"]},
        options: {type: optionsSchema, required: [true, "options not provided"]},
        answer: {type: String, enum: ["a","b","c","d"], required: [true, "answer not provided"]},
        stage: {type: Number, max: 3, min: 1, required: [true, "stage not provided"]},
        hint: {type: String, required: [true, "hint not provided"]},
